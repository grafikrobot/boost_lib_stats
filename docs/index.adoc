...
++++
<div id="cycles_chart_headers" style="height: 600px;"></div>
...
++++
<div id="cycles_chart_build" style="height: 600px;"></div>
<script type="text/javascript">
    ...
    series: [
        {
            ...
            upperLabel: { normal: { show: true, height: 40 } },
            itemStyle: { normal: { borderColor: '#fff' } },
            levels: [
                { itemStyle: { normal: { borderWidth: 0, gapWidth: 5 } } },
                {   colorSaturation: [0.35, 0.5],
                    itemStyle: { normal: {
                        borderWidth: 5, gapWidth: 1, borderColorSaturation: 0.6 } } }
            ],
            data:
